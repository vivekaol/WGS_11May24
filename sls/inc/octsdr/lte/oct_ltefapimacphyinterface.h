...
typedef enum
{
	...
	eDL_PDSCH_HANDLER_ERROR_INVALID_MCC_DETECTED=0x0400,
...
#define SIZE_TOCT_FAPI_UL_SCH_CQIRI_PDU_INFO ( tOCT_FAPI_UL_SCH_CQIRI_PDU_INFO  )
...
{
	/* SRS TA 
	   each unit is 2.04 nsec
	   this is a signed value */
	tOCT_INT16 sSrsTa[8];

} tOCT_FAPI_UL_SRS_INDICATION_VENDOR;

#define SIZE_TOCT_FAPI_UL_SRS_INDICATION_VENDOR (sizeof(tOCT_FAPI_UL_SRS_INDICATION_VENDOR))
