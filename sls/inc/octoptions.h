...
Description: Compiler conditionnal directives. 'octoptions_oadf'
...
mOCTOPTION_IGNORE( OCT_OPT_REMOVE_LICENSING )
mOCTOPTION_IGNORE( OCT_OPTION_OCTVC1_REMOVE_LICENSING_EXTERNAL )
