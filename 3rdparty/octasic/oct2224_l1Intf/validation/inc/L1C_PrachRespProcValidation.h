...
File: L1C_PrachRespProcValidation.h

Copyright (c) 2017 Octasic Technologies Private Limited. All rights reserved.

Description: 

   Layer1 Control Prach Response Procedure Validation
...
#ifndef _L1C_PRACHRESPPROCVALIDATION_H_
#define _L1C_PRACHRESPPROCVALIDATION_H_
