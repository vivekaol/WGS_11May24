...
#define   SYSTEM_INFORMATION_TYPE19                       20
...
#define UL_DCCH_MSG_TYPE_MEAS_CONTROL_FAILURE             7
#define UL_DCCH_MSG_TYPE_MEAS_CONTROL_REPORT              8
#define UL_DCCH_MSG_TYPE_PHY_CH_RECONF_COMP               9
#define UL_DCCH_MSG_TYPE_PHY_CH_RECONF_FAIL               10
#define UL_DCCH_MSG_TYPE_RRC_CONN_REL_COMP                17
#define UL_DCCH_MSG_TYPE_RRC_CONN_SETUP_COMP              18
#define UL_DCCH_MSG_TYPE_RRC_SIGNALLING_CONN_REL_IND      22
...
#define UMTS_SIB_MASK_SIB1	0x00000001
#define UMTS_SIB_MASK_SIB2	0x00000002
#define UMTS_SIB_MASK_SIB3	0x00000004
#define UMTS_SIB_MASK_SIB4	0x00000008
#define UMTS_SIB_MASK_SIB5	0x00000010
#define UMTS_SIB_MASK_SIB6	0x00000020
#define UMTS_SIB_MASK_SIB7	0x00000040
#define UMTS_SIB_MASK_SIB11	0x00000080
#define UMTS_SIB_MASK_SIB12	0x00000100
#define UMTS_SIB_MASK_SIB13	0x00000200
#define UMTS_SIB_MASK_SIB15	0x00000400
#define UMTS_SIB_MASK_SIB5BIS	0x00000800
#define UMTS_SIB_MASK_SIB17	0x00001000
#define UMTS_SIB_MASK_SIB19	0x00002000
/*
 * SRB RB Mapping Info
 */
...
#define NETWORK_BASED_ASSISTED_GPS                    0
#define UE_BASED_ASSISTED_GPS                         1
#define BOTH_NETWORK_BASED_AND_UE_BASED_ASSISTED_GPS  2
#define NO_NETWORK_BASED_ASSISTED_GPS                 3

#define UE_POS_ERR_NOT_ENOUGH_OTDOA_CELLS             0
#define UE_POS_ERR_NOT_ENOUGH_GPS_SATELLITE           1
#define UE_POS_ERR_ASSISTANCE_DATA_MISSING            2
#define UE_POS_ERR_NOT_ACCOMPLISHED_GPS               3
#define UE_POS_ERR_UNDEFINED                          4
#define UE_POS_ERR_REQ_DENIED_BY_USER                 5
#define UE_POS_ERR_NOT_PROCESSED_TIMEOUT              6
#define UE_POS_ERR_REF_CELL_NOT_SERVING_CELL          7
#define LATITUDE_SIGN_NORTH                           0
#define LATITUDE_SIGN_SOUTH                           1
#define ALTITUDE_SIGN_HEIGHT                          0
#define ALTITUDE_SIGN_DEPTH                           1

/*
 * UE Positioning Information
 */
typedef struct rrcUePostioningInfo
{
    int          gpsReferenceTime;
    unsigned int latitudeSign;
    int          latitude;
    int          longitude;
    unsigned int altitudePresence;
    unsigned int altitudeSign;
    int          altitude;
}RrcUePositioningInfo;
...
typedef struct rrcUlDCCHData
{
   ...
   unsigned int         ueBasedGpsEnabled;
   unsigned int         measReportErr;
   unsigned int         measReportErrCause;
   RrcUePositioningInfo uePosInfo;
...
typedef struct rrcConnectionRejectData
{
   RrcInitialUEIdentity  ueInitialIdentity;
   unsigned int          redirectionType;
   int                   dlUarfcn;                   
}RrcConnectionRejectData;
...
/*      
 * Multi PLMN structure
 */

typedef struct multiPlmnData
{              
   unsigned int numberOfPlmn;
   unsigned char mibPlmnIdentity; 
   PlmnData     plmnList[MAX_NO_OF_PLMN];
}MultiPlmnData;

typedef struct sib1Data
{
   unsigned char lac[MAX_LAC_LENGTH];
   int           rac;
   int           t3212;
   int           nmo;
}Sib1Data;
...
/*
 * Lte Priority Cell List
 */
typedef struct interRATLtePriorityCellInfo
{
   int earfcn;
   int priority;
   int qRxLevMinEUTRA;
   int threshXhigh;
   int threshXlow;
}InterRATLtePriorityCellInfo;

/*
 * UMTS FDD Priority Cell List
 */
typedef struct fddPriorityCellInfo
{
   int uarfcn;
   int priority;
   int threshXhigh;
 ...
 * UMTS FDD Priority Cell List
 */
typedef struct interRATGsmPriorityCellInfo
{
   int arfcn;
   int bandIndicator;
   int priority;
   ...
   int threshXhigh;
   int threshXlow;
}InterRATGsmPriorityCellInfo;

#define MAX_CELL_LIST       32
#define MAX_CELL_LIST       32
#define MAX_GSM_CELL_LIST       32
#define MAX_LTE_CELL_LIST       8
/*
...
typedef struct sysInfoType11FreqCellList
{
    ...
    InterRATCellInfo  interRATCellInfo[MAX_GSM_CELL_LIST];
}SysInfoType11FreqCellList;

typedef struct sysInfoType19FreqCellList
{
    int                          servingCellPriority;
    int                          s_PrioritySearch1;
    int                          s_PrioritySearch2;
    int                          threshServingLow;
    FddPriorityCellInfo          fddPriorityCellInfo[MAX_LTE_CELL_LIST];
    InterRATLtePriorityCellInfo  interRATLtePriorityCellInfo[MAX_LTE_CELL_LIST];
    InterRATGsmPriorityCellInfo  interRATGsmPriorityCellInfo[MAX_LTE_CELL_LIST];
}SysInfoType19FreqCellList;

/*
 * Paging Cause
 */
#define PAGING_CAUSE_TERMINATING_CONVERSATIONAL_CALL      0
#define PAGING_CAUSE_TERMINATING_STREAMING_CALL           1
#define PAGING_CAUSE_TERMINATING_INTERACTIVE_CALL         2
#define PAGING_CAUSE_TERMINATING_BACKGROUND_CALL          3
#define PAGING_CAUSE_TERMINATING_HIGH_PRIORITY_SIGNALLING 4
#define PAGING_CAUSE_TERMINATING_LOW_PRIORITY_SIGNALLING  5
#define PAGING_CAUSE_TERMINATING_CAUSE_UNKNOWN            6
#define PAGING_CAUSE_SPARE                                7

/*
 * RRC Paging Type1 Data
 */
typedef struct rrcPagingType1Data
{
    unsigned int    pagingCause;
    unsigned int    cnDomainType;
    unsigned int    imsiLength;
    int             imsi[MAX_IMSI_LENGTH]; 
}RrcPagingType1Data;

#define PAGING_RECORD_TYPE_ID_IMSI_GSM_MAP        0
#define PAGING_RECORD_TYPE_ID_TMSI_GSM_MAP_P_TMSI 1
#define PAGING_RECORD_TYPE_ID_IMSI_DS_41          2
#define PAGING_RECORD_TYPE_ID_TMSI_DS_41          3
/*
 * RRC Paging Type2 Data
 */
typedef struct rrcPagingType2Data
{
    int           rrcTransactionId;
    unsigned int  pagingCause;
    unsigned int  cnDomainType;
    unsigned int  pagingRecordTypeId;
}RrcPagingType2Data;


/*
 * RRC Physical Channel Reconfig Data
 */
typedef struct rrcPhyChReconfigData
{
    int           rrcTransactionId;
    int           maxUlTxPwr;
}RrcPhyChReconfigData;

/*
 * RRC Measurement Control Data
 */
#define RRC_MEASUREMENT_CONTROL_COMMAND_SETUP           0
#define RRC_MEASUREMENT_CONTROL_COMMAND_MODIFY          1
#define RRC_MEASUREMENT_CONTROL_COMMAND_RELEASE         2
#define RRC_MEAS_CNTRL_REPORTING_CRITERIA_UE_POS        0
#define RRC_MEAS_CNTRL_REPORTING_CRITERIA_PERIODICAL    1
#define RRC_MEAS_CNTRL_REPORTING_CRITERIA_NO_REPORT     2
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_1               0
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_2               1
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_4               2
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_8               3
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_16              4
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_32              5
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_64              6
#define RRC_MEAS_CNTRL_REPORTING_AMOUNT_INFINITY        7
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_NO_PERIODIC   0
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_0_25          1
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_0_5           2
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_1             3
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_2             4
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_4             5
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_8             6
#define RRC_MEAS_CNTRL_REPORTING_INTERVAL_16            7

typedef struct rrcMeasCntrlReportingCriteria
{
   int isReportingAmountPresent;
   int reportingAmount;
   int reportingInterval;
}RrcMeasCntrlReportingCriteria;
 
typedef struct rrcMeasCntrlGpsRefTime
{
   int gpsWeek;
   int gpsTow;
   int isUtranGpsRefTimePresent;
}RrcMeasCntrlGpsRefTime;

#define MAX_SAT_ID   10

typedef struct rrcMeasCntrlGpsNavMod
{
   int numOfSat;
   int satId[MAX_SAT_ID];
}RrcMeasCntrlGpsNavMod;

typedef struct rrcMeasurementControlData
{
   int                           rrcTransactionId;
   int                           measurementId;
   int                           measurementCommand;
   int                           reportingCriteriaType;
   RrcMeasCntrlReportingCriteria reportCriteria;
   int                           isUePositioningGpsAssitancePresent;
   int                           isUePositioningGpsRefTimePresent;
   RrcMeasCntrlGpsRefTime        gpsRefTime;
   int                           isUePositioningNavigationModelPresent;
   RrcMeasCntrlGpsNavMod         gpsNavMod;
}RrcMeasurementControlData;

/*
 * Method Declaration
 */
extern ASNRetCode_t initializeASNContextWithInputFile (char *fileName);

extern ASNRetCode_t initializeASNContext (void);

extern void cleanASNContext (void);

extern void cleanASNContextWithInputFile(void);
...
extern void fillASNMIBSIBReferenceList (unsigned int maxIndex, 
                                        ...
                                        int          sib11SegCount,
                                        int          configureSib5bis);

extern void fillASNMIBMultiPLMNIdentity(unsigned int numOfPlmn,
                                        PlmnData *plmnList,
                                        unsigned char mibPlmnIdentity);
...
extern void fillASNSysInfoType3CellAccessRestrictionCell (int cellAccessRestricton, int interFreCellReselectInd, int t_barred);
...
extern ASNRetCode_t encodeASNSib5bis (int  *pSib5EncodedLength,
                                      char *pSib5OutputBuffer);

extern void cleanASNSIB5bisValue (void);
...
extern ASNRetCode_t decodeASNMib (unsigned char *pMibBuffer,
                                  int mibBufferLength,
                                  MultiPlmnData *pMultiPlmnData,
                                  unsigned int * sibMask);
...
extern ASNRetCode_t decodeASNSib19 (unsigned char *pSib19Buffer,
                                    int sib19BufferLength,
                                    SysInfoType19FreqCellList  *pSysInfoType19FreqCellList);           

extern ASNRetCode_t decodeASNULCCCHMessage (unsigned char        *pULCCCHBuffer, 
                                            int                   ulCCCHLength,
                                            int                  *pMsgType,
                                            RrcInitialUEIdentity *pInitUEIdentity,
                                            unsigned int         *pEmergencyCall);
...
extern ASNRetCode_t fillAndEncodePagingType1 (RrcPagingType1Data  *pRrcPgType1,
                                              unsigned char      **pEncodedData,
                                              unsigned int        *pEncodedDataLen);

extern ASNRetCode_t fillAndEncodePagingType2 (RrcPagingType2Data *pRrcPagingType2Data,
                                              unsigned char     **pEncodedData,
                                              unsigned int       *pEncodedDataLen);

extern ASNRetCode_t fillAndEncodePhyChReconfig (RrcPhyChReconfigData  *pRrcPhyChReconfigData,
                                                unsigned char        **pEncodedData,
                                                unsigned int          *pEncodedDataLen);

extern ASNRetCode_t fillAndEncodeRrcMeasurementControl (RrcMeasurementControlData *pRrcMeasCtrl,
                                                        unsigned char            **pEncodedData,
                                                        unsigned int              *pEncodedDataLen);

extern ASNRetCode_t fillAndEncodeRrcConnectionReject (RrcConnectionRejectData   *pRrcConnRejData,
                                                      unsigned char             **pEncodedData,
                                                      unsigned int              *pEncodedDataLen);
