...
#define ED_HANDLE_OPTIONAL_IE_SYNTAX_ERROR(IEI,ERRID,FIELD)
#endif
...
#define ED_HANDLE_CONDITIONAL_IE_SYNTAX_ERROR(IEI,ERRID,FIELD) return ED_CONDITIONAL_IE_SYNTAX_ERROR;
#endif
...
#define ED_HANDLE_OPTIONAL_IE_MSG_TOO_SHORT(IEI,ERRID,FIELD) {CurrOfs = (BitOffset+Length);}
#endif
...
#define ED_HANDLE_CONDITIONAL_IE_MSG_TOO_SHORT(IEI,ERRID,FIELD) return ED_CONDITIONAL_IE_SYNTAX_ERROR;
#endif
...
#define ED_HANDLE_IE_SIZE_ERROR(IEI,ERRID,FIELD) return ED_IE_SIZE_ERROR;
#endif
