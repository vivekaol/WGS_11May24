...
ED_EXPORT_CALL (ED_EXLONG, ENCODE_c_SMS_SUBMIT_REPORT_RP_ERROR (char* ED_CONST Buffer, ED_CONST ED_EXLONG BitOffset, const c_SMS_SUBMIT_REPORT_RP_ERROR* ED_CONST Source))
{
	...
	if (Source->TP_UD_Present) {
		Len = ENCODE_c_TP_UD (Buffer, CurrOfs, Source->TP_UD, THIS->TP_UDHI, PTR_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_DCS(THIS->TP_DCS));
	} else {
		Len=0;
	}
	CurrOfs += Len;
...
ED_EXPORT_CALL (ED_EXLONG, DECODE_c_SMS_SUBMIT_REPORT_RP_ERROR (const char* ED_CONST Buffer, ED_CONST ED_EXLONG BitOffset, c_SMS_SUBMIT_REPORT_RP_ERROR* ED_CONST Destin, ED_EXLONG Length))
{
	...
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:118> Message too short decoding subfield header\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 117, (Destin->header))
	} 
#endif
	/* Implementation of TP_UDHI - 1 bit(s) at bit n. 6 */
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:120> Message too short decoding subfield TP_FCS\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 119, (Destin->TP_FCS))
	} 
#endif
	Len = DECODE_c_TP_PI (Buffer, CurrOfs, (&(Destin->TP_PI)), (Length-(CurrOfs-BitOffset)));CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:122> Message too short decoding subfield TP_PI\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 121, (Destin->TP_PI))
	} 
#endif
	Len = DECODE_c_TTimeStamp (Buffer, CurrOfs, (&(Destin->TP_SCTS)), (Length-(CurrOfs-BitOffset)));CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:124> Message too short decoding subfield TP_SCTS\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 123, (Destin->TP_SCTS))
	} 
#endif
	if (THIS->TP_PI.TP_PID) {
		ED_CHECK_OUT_OF_MEMORY_KEEP/*COOMK16*/(/*SETP2*/SETPRESENT_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_PID (Destin, ED_TRUE), != ED_NO_ERRORS)
		Len = DECODE_c_TP_PID (Buffer, CurrOfs, Destin->TP_PID, (Length-(CurrOfs-BitOffset)));
	} else {
		ED_CHECK_OUT_OF_MEMORY_KEEP/*COOMK16*/(/*SETP2*/SETPRESENT_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_PID (Destin, ED_FALSE), != ED_NO_ERRORS)
		Len=0;
	}CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:126> Message too short decoding subfield TP_PID\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 125, (Destin->TP_PID))
	} 
#endif
	if (THIS->TP_PI.TP_DCS) {
		ED_CHECK_OUT_OF_MEMORY_KEEP/*COOMK16*/(/*SETP2*/SETPRESENT_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_DCS (Destin, ED_TRUE), != ED_NO_ERRORS)
		Len = DECODE_c_TP_DCS (Buffer, CurrOfs, Destin->TP_DCS, (Length-(CurrOfs-BitOffset)));
	} else {
		ED_CHECK_OUT_OF_MEMORY_KEEP/*COOMK16*/(/*SETP2*/SETPRESENT_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_DCS (Destin, ED_FALSE), != ED_NO_ERRORS)
		Len=0;
	}CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:128> Message too short decoding subfield TP_DCS\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 127, (Destin->TP_DCS))
	} 
#endif
	if (THIS->TP_PI.TP_UDL) {
		ED_CHECK_OUT_OF_MEMORY_KEEP/*COOMK16*/(/*SETP2*/SETPRESENT_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_UD (Destin, ED_TRUE), != ED_NO_ERRORS)
		Len = DECODE_c_TP_UD (Buffer, CurrOfs, Destin->TP_UD, (Length-(CurrOfs-BitOffset)), THIS->TP_UDHI, PTR_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_DCS(THIS->TP_DCS));
	} else {
		ED_CHECK_OUT_OF_MEMORY_KEEP/*COOMK16*/(/*SETP2*/SETPRESENT_c_SMS_SUBMIT_REPORT_RP_ERROR_TP_UD (Destin, ED_FALSE), != ED_NO_ERRORS)
		Len=0;
	}CurrOfs += Len;
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:130> Message too short decoding subfield TP_UD\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 129, (Destin->TP_UD))
	} 
#endif
	...
	if ((Length-(CurrOfs-BitOffset)) > 0) {
		/* BINDEC02 */
		ALLOC_c_SMS_SUBMIT_REPORT_RP_ERROR_spare (&(Destin->spare), (Length-(CurrOfs-BitOffset)));
...
#ifndef ED_NO_EXTENSIVE_ERROR_LOGGING
	if (CurrOfs > (BitOffset+Length)) {
		ED_SIGNAL_ERROR ("<ERRID:132> Message too short decoding subfield spare\n");
		ED_HANDLE_MANDATORY_IE_MSG_TOO_SHORT ((-1), 131, (Destin->spare))
	} 
#endif
