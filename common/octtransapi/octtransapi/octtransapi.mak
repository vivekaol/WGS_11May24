...
# 
#---------------------------------------------------------------------------------------#
SRC_DIR = source source/porting/linux 
...
#
#---------------------------------------------------------------------------------------#
SRC_FILES = transapi_close.c transapi_destination.c transapi_dispatcher.c \
	transapi_init.c transapi_local_ctx.c transapi_recv.c  \
	transapi_select.c transapi_local.c
...
#
#---------------------------------------------------------------------------------------#
OCTLIB_DEP = ../common/octosal/octosal.mak
